...
export default function TripCard({ trip }) {
  ...
  return (
    <Link to={`/view-trip/${trip.id}`}>
      <div className="text-black h-full p-4 flex flex-col gap-4 rounded-lg max-w-[350px] hover:bg-[#DBFF73] cursor-pointer bg-white shadow-lg hover:scale-105 transition-all">
